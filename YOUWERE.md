...
# CubeStack - Jogo de Cubos 3D

## Visão Geral do Projeto

- **Nome do Projeto**: CubeStack
- **Tipo**: Landing Page + Jogo Web 3D
- **Stack**: React + TypeScript + Tailwind CSS + Framer Motion + Three.js
- **Tema**: Preto e branco com elementos geométricos de cubos

## Funcionalidades Implementadas

### Landing Page
- **Design Minimalista**: Fundo preto (#000000) com elementos em branco
- **Tipografia Moderna**: Texto limpo e legível
- **Efeito 3D no Botão**: Botão "JOGAR" com efeito de profundidade que se eleva e brilha ao passar o mouse
- **Animações Suaves**: Elementos flutuantes e transições com Framer Motion
- **Ilustrações de Regras**: 
  - Rotacionar (setas circulares)
  - Ativar (indicador de clique)
  - Formar (padrão pixel)

### Jogo (Three.js)
- **Grid 3D de Cubos**: Grade 7x7 de cubos interativos
- **Controles de Rotação**:
  - **Botões visuais**: Painel com 8 direções (↑↓←→ + ↖↗↙↘) na parte inferior da tela
  - **Círculos ao redor**: Clique nos círculos ao redor dos cubos para rotacionar
  - **Mouse**: Arraste para rotacionar livremente
  - **Teclado**: 
    - ← → ↑ ↓ ou A/D/W/S para direções cardeais
    - Q/E/Z/C para diagonais
- **Interação com Cubos**: Clique nos cubos para ativar/desativar
- **Sistema de Níveis**: 4 padrões pixel art para formar:
  - Coração
  - Estrela
  - Casa
  - Flecha
- **Verificação de Vitória**: O jogo detecta automaticamente quando o padrão é completado
- **Sistema de Pontos**: +100 pontos por nível completado
